...
import { FileSpreadsheet, ChevronDown, ChevronRight, X, Hash, Type, Calendar, ToggleLeft, HelpCircle } from "lucide-react";
...
export default function DatasetList({ datasets, onRemove }: DatasetListProps) {
